...
* ✨ **隨身法學錦囊（AI 智慧對話）**：抽屜式面板隨手喚醒，支援快捷訴訟情境推演、長句語音口述與書狀照片辨識，個人免費 API Key 直連官方，隱私絕不外洩。
...
2. 庭期結束後，點擊「📋 一鍵複製純文字」，快速貼進事務所通訊群組或 Email 回報委任當事人。
3. 右上方提供一鍵清理特殊標記符號工具，並支援另存標準 .txt 純文字檔。

### 【情境四：候庭攻防推演、當事人白話通報與 AI 智慧諮詢】
👉 點擊頂部 **【✨ 隨身法學錦囊】**：
1. **專屬隨身法學顧問隨手喚醒**：點擊螢幕頂部右上方「✨」按鈕，立即由下方滑出抽屜式 AI 對話面板，不中斷手邊正在查看的案件或庭期；只要設定 Google AI Studio 免費 API Key 即可使用（不生費用負擔）。
2. **內建實戰訴訟快捷情境**：橫向滑動上方快捷膠囊，一鍵帶入精選提示詞：
...
3. **支援多模態分析與語音輸入**：
   ...
   - 【🎙️ 長句語音直錄】：點擊麥克風口述案情，AI 自動校正台灣法律術語與同音錯字。
4. **隱私第一與免費額度**：採用個人本機金鑰直連 Google 官方 AI 端點，對話內容不上傳第三方伺服器，受任業務機密 100% 自主掌控，且享每日個人大量免費額度。
